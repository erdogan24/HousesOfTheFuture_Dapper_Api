...
namespace HousesOfTheFuture_Dapper_Api.Repositories.StatisticsRepositories
{
    public class StatisticsRepository : IStatisticsRepository
    {
        ...
        {
            string query = "Select Avg(Price) From Product where City = 'İzmir'";
            using (var connection = _context.CreateConnection())
            {
        ...
        {
            string query = "Select Avg(Price) From Product where City = 'Antalya'";
            using (var connection = _context.CreateConnection())
            {
                var values = connection.QueryFirstOrDefault<decimal>(query);
                return values;
