using HousesOfTheFuture_Dapper_UI.DTOS.MessageDtos;
using HousesOfTheFuture_Dapper_UI.Services;
using Microsoft.AspNetCore.Mvc;
using Newtonsoft.Json;

namespace HousesOfTheFuture_Dapper_UI.Areas.EstateAgent.ViewComponents.EstateAgentNavbarViewComponents
{
